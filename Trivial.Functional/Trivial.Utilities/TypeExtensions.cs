...
public static class TypeExtensions
{
    ...
    public static Result<T> As<T>(this object Object) where T : class =>
        (Object as T)!;
    public static Result<T> As<T>(this object Object, Action<T> OnNotNull) where T : class =>
    ...
    {
        if(Object.HasValue)
            return (Object.Value as T2)!.ToMaybe().Chain(OnNotNull);
        return default;
    }
